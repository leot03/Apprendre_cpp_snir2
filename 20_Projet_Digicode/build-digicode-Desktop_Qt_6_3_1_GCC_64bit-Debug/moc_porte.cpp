...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Porte_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Porte_t qt_meta_stringdata_Porte = {
    {
QT_MOC_LITERAL(0, 5) // "Porte"
...
const QMetaObject Porte::staticMetaObject = { {
    ...
    qt_meta_stringdata_Porte.offsetsAndSize,
    qt_meta_data_Porte,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Porte_t
, QtPrivate::TypeAndForceComplete<Porte, std::true_type>
